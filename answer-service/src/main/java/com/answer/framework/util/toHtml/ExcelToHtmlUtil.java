package com.answer.framework.util.toHtml;

import com.answer.framework.util.FileUtils;
...
public class ExcelToHtmlUtil {
    ...
    public static void main(String[] args) {
        excelToHtml("D:\\files\\excel.xls", "D:\\files\\excel.html", true);
    }

    public static String excelToHtml(InputStream inputStream, boolean isWithStyle) {
    ...
    private static String convertAlignToHtml(short alignment) {
        ...
        if (alignment == HorizontalAlignment.LEFT.getCode()){
            align = "left";
        }else if (alignment == HorizontalAlignment.CENTER.getCode()){
            align = "center";
        }else if (alignment == HorizontalAlignment.RIGHT.getCode()){
            align = "right";
        }
        return align;
    }
